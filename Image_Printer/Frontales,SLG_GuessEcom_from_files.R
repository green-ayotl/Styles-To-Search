...
margen_inferior <- 338 # Margen inferior carteras

# frame para central de acuerdo a estetica ecom
frame_alto <- "3168"
frame_ancho <- as.character(as.numeric(canvas_ancho) - (margen_inferior*3)) # = 2400 - (246 *2)  margen de cada lado = anchura interna de la imagen
